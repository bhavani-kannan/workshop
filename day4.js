  ...
  el.innerHTML = `
    <div class="accordion-body">
      ...
      <div class="day-objective-block">
        ...
        <p>
          Define the complete design specification: the metrics the agent measures — each anchored
          against the current performance baseline — the decision logic it applies including how it
          correlates MES and ERP signals, the concepts and filter rules it uses, and the constraints,
          approval rules, and guardrails it operates within. Everything agreed today goes directly into the build brief.
      ...
      <div class="sessions">
              ...
              <div class="session-grid">
                ...
                <div class="block">
                  ...
                  <ul>
                    ...
                    <li>Does any metric decompose into sub-metrics — and for each sub-metric, how is it actually calculated from raw source data?</li>
        ...
        <div class="session">
          <div class="session-toggle">
            ...
            <div class="session-meta">
              <h3>Decision Logic, Concepts, and Human Control Design</h3>
              <p class="session-desc">
                Define the logic the agent applies to reach a recommendation, including how it correlates
                MES exceptions with ERP signals. Define the reusable concepts and filter rules the logic depends on.
                Classify every recommendation type as requiring human approval before action or human oversight
                after the fact, and specify audit trail and explainability requirements.
              </p>
            </div>
            <span class="session-chevron"></span>
          </div>
            ...
            <div class="session-content-inner">
              <div class="session-grid">
                <div class="block">
                  ...
                  <ul>
                    ...
                    <li>Name the reusable concepts the logic depends on: time windows (today, this shift, this week, last 30 days) and operational filter rules (unplanned downtime only, night shift only, high-priority orders only). Define the exact filter logic for each so it is applied consistently.</li>
                ...
                <div class="block">
                  ...
                  <ul>
                    ...
                    <li>Concept and filter rule template: name, kind (time window or operational filter), exact filter logic in plain language, and the source columns it applies to.</li>
              ...
              <div class="output-box">
                ...
                <ul>
                  ...
                  <li>Concepts catalogue: named time windows and operational filter rules, each with exact filter logic and the source columns it applies to.</li>
        ...
        <div class="session">
          <div class="session-toggle">
            ...
            <div class="session-meta">
              <h3>Constraints, Guardrails, and Approval Design</h3>
              <p class="session-desc">
                Define the hard limits the agent must never exceed, the approval steps for out-of-range
                recommendations, the feedback loop back to the ERP when a shop-floor decision is made,
                and what the agent says when it cannot produce a reliable recommendation.
                Draft the executive summary brief for Day 5 endorsement.
              </p>
            </div>
            <span class="session-chevron"></span>
          </div>
              ...
              <div class="session-grid">
                <div class="block">
                  ...
                  <ul>
                    ...
                    <li>Define fallback behavior and fallback language: what the agent does and what it says to the operator when data is missing, stale, or confidence falls below threshold. The agent must never silently produce a low-quality recommendation.</li>
      ...
      <div class="end-day">
        ...
        <div class="end-day-grid">
          ...
          <div class="end-card">Concepts catalogue with HITL and HOTL classification per recommendation type</div>
